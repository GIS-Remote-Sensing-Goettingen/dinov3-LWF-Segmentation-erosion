...
- Roads penalty: `ROADS_MASK_PATH`, `ROADS_MASK_RASTER_PATH`, `ROADS_RASTER_AUTO_BUILD`, `ROADS_PENALTY_VALUES`.
...
- Roads raster: auto-built once at tile resolution over SOURCE_LABEL_RASTER extent and window-read per tile.
